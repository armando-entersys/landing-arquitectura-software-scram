...
export const is: SiteContent = {
  ...
  caseStudies: {
    ...
    cases: [
      ...
      {
        title: 'MiTec háskóla ofurapp',
        company: 'Tecnológico de Monterrey',
        industry: 'Háskólamenntun',
        challenge: 'Líf nemenda dreift yfir margar ótengdar stafrænar kerfiseiningar, engin sameinuð stafræn auðkenni og gríðarlegir umferðartoppar á skráningartímabilum sem hrundu núverandi kerfum.',
        solution: 'Innfædd iOS/Android ofurapp byggð á smáþjónustuarkitektúr, með stafrænu auðkenni með sannanlegu QR, aðgangi að háskólaþjónustu, símaskrá, umsóknum og ýtitilkynningum — allt í einu appi fyrir 100.000+ samtímis notendur.',
        results: [
          { metric: '100K+', label: 'Virkir notendur' },
          { metric: 'Ofurapp', label: 'iOS og Android' },
          { metric: 'Stafrænt ID', label: 'QR skilríki' },
        ],
        image: '/images/cases/tec/tec-home.webp',
        testimonial: 'Allt sem nemandi þarf í einu appi: skilríki, stundaskrá, umsóknir, símaskrá. Sundrunginn er lokið.',
      },
      {
  ...
  testimonials: {
    ...
    items: [
      ...
      {
        quote: 'Allt sem nemandinn þarf í einu appi: skilríki, stundatöflu, umsóknir, símaskrá. Sundrungin er búin.',
        author: 'Carolina Estrada',
        role: 'Tæknistjóri',
        company: 'Tecnológico de Monterrey — Háskólamenntun',
        image: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=400&h=400&fit=crop&crop=face&q=80',
      },
      {
        quote: 'Viðskiptavinir sjá pöntunina sína í rauntíma. Misheppnaðar sendingar minnkuðu verulega.',
        author: 'Miguel Ángel Torres',
        role: 'Flutningastjóri',
        company: 'Landsdreifing — Vörustjórnun og dreifing',
  ...
  booking: {
    modalTitle: 'Bóka arkitektúrfund',
    stepCalendar: 'Dagsetning',
    stepTime: 'Tími',
    stepForm: 'Upplýsingar',
    stepConfirmation: 'Staðfesting',
    selectDate: 'Veldu dagsetningu',
    selectTime: 'Veldu tíma',
    closed: 'Lokað',
    noSlots: 'Engir tímar lausir á þessari dagsetningu',
    loading: 'Hleð lausum tímum...',
    nameLabel: 'Fullt nafn',
    emailLabel: 'Vinnunetfang',
    phoneLabel: 'Sími (valfrjálst)',
    notesLabel: 'Athugasemdir (valfrjálst)',
    phonePlaceholder: '+354 ...',
    notesPlaceholder: 'Segðu okkur stuttlega frá verkefninu þínu...',
    submitText: 'Staðfesta bókun',
    submitting: 'Bóka...',
    confirmationTitle: 'Bókun staðfest!',
    confirmationSubtitle: 'Þú færð staðfestingarpóst með nánari upplýsingum.',
    meetLinkLabel: 'Hlekkur á myndfund:',
    joinMeet: 'Tengjast Google Meet',
    closeButton: 'Loka',
    errorSlotTaken: 'Þessi tími er ekki lengur laus. Vinsamlegast veldu annan.',

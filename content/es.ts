...
export const es: SiteContent = {
  ...
  booking: {
    modalTitle: 'Agendar sesión de arquitectura',
    stepCalendar: 'Fecha',
    stepTime: 'Hora',
    stepForm: 'Datos',
    ...
    phonePlaceholder: '+52 ...',
    notesPlaceholder: 'Cuéntanos brevemente sobre tu proyecto...',
    submitText: 'Confirmar cita',
    submitting: 'Agendando...',
    confirmationTitle: '¡Cita agendada!',
    confirmationSubtitle: 'Recibirás un email de confirmación con los detalles.',
    meetLinkLabel: 'Enlace a la videollamada:',
    joinMeet: 'Unirse a Google Meet',
    closeButton: 'Cerrar',
    errorSlotTaken: 'Este horario ya no está disponible. Por favor selecciona otro.',

...
export const en: SiteContent = {
  ...
  caseStudies: {
    ...
    cases: [
      ...
      {
        title: 'MiTec University Super App',
        company: 'Tecnológico de Monterrey',
        industry: 'Higher Education',
        challenge: 'Student life scattered across multiple disconnected platforms, no unified digital identity, and brutal traffic spikes during enrollment periods that crashed existing systems.',
        solution: 'Native iOS/Android Super App built on a micro-services architecture, featuring a digital ID with verifiable QR, campus services access, directory, procedures, and push notifications — all in a single app for 100,000+ concurrent users.',
        results: [
          { metric: '100K+', label: 'Active users' },
          { metric: 'Super App', label: 'iOS & Android' },
          { metric: 'Digital ID', label: 'QR credential' },
        ],
        image: '/images/cases/tec/tec-home.webp',
        testimonial: 'Everything a student needs in one app: ID, schedules, procedures, directory. The fragmentation is over.',
      },
      {
  ...
  testimonials: {
    ...
    items: [
      ...
      {
        quote: 'Everything a student needs in one app: ID, schedules, paperwork, directory. The fragmentation is over.',
        author: 'Carolina Estrada',
        role: 'Chief Technology Officer',
        company: 'Tecnológico de Monterrey — Higher Education',
        image: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=400&h=400&fit=crop&crop=face&q=80',
      },
      {
        quote: 'Customers see their order in real time. Failed deliveries dropped dramatically.',
        author: 'Miguel Ángel Torres',
        role: 'Logistics Manager',
        company: 'National Distributor — Logistics & Distribution',
  ...
  booking: {
    modalTitle: 'Book an architecture session',
    stepCalendar: 'Date',
    stepTime: 'Time',
    stepForm: 'Details',
    ...
    phonePlaceholder: '+1 ...',
    notesPlaceholder: 'Tell us briefly about your project...',
    submitText: 'Confirm booking',
    submitting: 'Booking...',
    confirmationTitle: 'Booking confirmed!',
    confirmationSubtitle: 'You\'ll receive a confirmation email with the details.',
    meetLinkLabel: 'Video call link:',
    joinMeet: 'Join Google Meet',
    closeButton: 'Close',
    errorSlotTaken: 'This time slot is no longer available. Please select another.',

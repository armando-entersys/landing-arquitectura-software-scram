            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <div className="flex flex-col sm:flex-row gap-2 md:gap-3 justify-center md:justify-start">
                ...
                >
                  ...
                  {content.ui.scheduleCall}
                </button>
                <button
                  onClick={() => {
                    tracker.trackCTA(content.ui.whatsAppDirect, 'team', 'whatsapp');
                    const msg = encodeURIComponent(content.ui.whatsAppTeamMsg);

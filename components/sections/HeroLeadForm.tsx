    ...
    <div className="bg-white rounded-card shadow-card-hover border border-scram-border overflow-hidden">
      ...
      <div className="p-6 lg:p-8">
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            className="w-full flex items-center justify-center gap-2 px-6 py-3.5 bg-scram-primary hover:bg-scram-primaryHover text-white font-semibold text-base rounded-pill shadow-button transition-all duration-300 hover:-translate-y-0.5"
          >
